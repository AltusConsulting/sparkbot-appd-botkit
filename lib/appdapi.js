    ...
    var appdAPI = {
        events: {
            get: function(appID, cb) {
                ...
                var resource = '/controller/rest/applications/'+ appID + '/events?output=JSON&time-range-type=BEFORE_NOW&duration-in-mins=11000&event-types=' + eventTypes + '&severities=INFO,WARN,ERROR';
